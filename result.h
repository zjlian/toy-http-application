...
#include "value_common/macro_utility.h"
...
template <class R,
          class S = std::errc,
          class NoValuePolicy = boost::outcome_v2::policy::default_policy<R, S, void>>
class MUST_USE Result : protected boost::outcome_v2::result<R, S, NoValuePolicy>
{
public:
